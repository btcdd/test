...
//		buffer.append("javac -d . Test.java");
		buffer.append("javac -sourcepath /userDirectory/user" + authUserNo + "/prob" + problemNo + "/subProb" + subProblemNo + "/java -d /userDirectory/user" + authUserNo + "/prob" + problemNo + "/subProb" + subProblemNo + "/java/ /userDirectory/user" + authUserNo + "/prob" + problemNo + "/subProb" + subProblemNo + "/java/*.java");
